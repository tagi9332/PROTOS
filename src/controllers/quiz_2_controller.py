...
def quiz_2_step(state: dict, config: dict) -> dict:
    ...
    a_c, e_c, i_c, RAAN_c, AOP_c, TA_c = inertial_to_orbital_elements(r_chief, v_chief)
    ...
    r_deputy_des, v_deputy_des = orbital_elements_to_inertial(a_d_des, e_d_des, i_d_des, RAAN_d_des, AOP_d_des, np.degrees(TA_d_des))
